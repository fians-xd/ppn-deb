...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 50000 -p 109 -p 110 -p 69 -w -1 -c aes128-ctr,aes192-ctr,aes256-ctr,3des-cbc,aes128-gcm,aes256-gcm,chacha20-poly1305"/g' /etc/default/dropbear
