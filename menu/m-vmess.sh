...
echo -e " [\e[36m4\e[0m] Extending Account Vmess "
echo -e " [\e[36m5\e[0m] Delete Account Vmess "
echo -e " [\e[36m6\e[0m] Check User Login Vmess "
...
5) clear ; del-ws ; exit ;;
6) clear ; cek-ws ; exit ;;
7) clear ; cat /etc/log-create-vmess.log ; exit ;;
0) clear ; menu ; exit ;;
x) exit ;;
